    ...
    <body>
        ...
        <div id="container">
            ...
            <div id="body">
                ...
                echo form_fieldset('Serch for Deleting Information');
                echo form_open('Empresa/get_empresa');
                echo "<br>";
                echo form_input('empresa_id', 'empresa_id');
                echo form_submit('myBuscarDelete', 'Buscar!');
                echo form_close();
                ...
                if (!empty($empresa)) {
                    ...
                    print_r($json);
                    echo "</pre>";
                    echo form_fieldset('Eliminar Information');
                    echo form_open('Empresa/delete_empresa');
                    echo "<br>";
                    echo form_input('empresa_id', $empresa['empresa_id']);
                    echo "<br>";
                    ...
                    echo "<br>";
                    echo form_submit('myEliminar', 'Eliminar!');
                    echo form_close();
                    echo form_fieldset_close();
                }
                ?>
